...
peaks_fasta='/lustre/scratch126/cellgen/team205/is10/fibroblasts/bulk_cytokines/cistarget/all_peaks.fa'
## Directory of cistarget database to be created
out_dir='/lustre/scratch126/cellgen/team205/is10/fibroblasts/bulk_cytokines/cistarget/cistarget_db'
